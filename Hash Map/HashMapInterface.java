...
public interface HashMapInterface<K, V> {
    ...
    /**
     * Adds the given key-value pair to the hash map.
     * If the key is already in the hash map, then replace the value with this
     * value.
     *
     * Check to see if the backing array needs to be regrown BEFORE
     * adding. For example, If my hash map has a backing array of length 5, and
     * currently has 3 elements in it, I should regrow at the start of the next
     * add operation. The regrowing should occur even if the key being added is
     * a duplicate key.
     *
     ...
     *
     * @param key key to add into the hash map.
     * @param value value to add into the hash map.
     ...
     * You should use {@code java.util.HashSet}.
     * Should be O(n).
     *
     ...
     * Use any class that implements the {@code java.util.List} interface.
